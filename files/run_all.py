...
if __name__ == "__main__":
    ...
    run_step("step1_prepare_data.py", "STEP 1: Data Preparation")
    run_step("step2_aspect_extraction.py", "STEP 2: Aspect Extraction")
    run_step("step3_train_models.py", "STEP 3: Model Training")
    run_step("step4_baseline_comparison.py", "STEP 4: Baseline Comparison")
