...
ASPECT_KEYWORDS = {
    "course_content": [
        "syllabus", "curriculum", "course", "content", "topic", "subject",
        "module", "material taught", "lecture content", "course material",
        "study plan", "course structure", "theory"
    ],
    "teaching_quality": [
        "teacher", "professor", "faculty", "instructor", "teaching", "lecture",
        "explain", "class", "staff", "mentor", "trainer", "educator",
        "teaches", "taught", "professor"
    ],
    "assessment": [
        "exam", "test", "assignment", "quiz", "grade", "grading", "marks",
        "evaluation", "assessment", "project", "deadline", "score", "viva",
        "practical exam", "paper"
    ],
    "resources": [
        "library", "book", "material", "resource", "journal", "reference",
        "notes", "handout", "e-resource", "database", "study material",
        "online resource", "pdf"
    ],
    "infrastructure": [
        "lab", "classroom", "wifi", "internet", "equipment", "facility",
        "campus", "projector", "computer", "infrastructure", "building",
        "canteen", "hostel", "smart board", "machine"
    ]
}
...
if __name__ == "__main__":
    ...
    for aspect in ASPECT_KEYWORDS:
        ...
        if len(labeled) > 0:
            ...
            print(f"{aspect:25s}: {acc:.0f}% recall ({len(detected_correctly)}/{len(labeled)} correctly detected)")
